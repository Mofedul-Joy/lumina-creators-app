        ...
        <>
          ...
          {r.banner_url ? (
            <div className="relative mt-2 aspect-[16/9] w-full overflow-hidden rounded-[var(--radius-card)] bg-[var(--color-surface-2)]">
              <ImgFallback src={r.banner_url} className="h-full w-full object-cover" />
                    ...
                    <div className="relative aspect-video w-full bg-[var(--color-surface-2)]">
                      {(() => {
                        ...
                        return s.thumbnail_url ? (
                          <ImgFallback src={s.thumbnail_url} className="h-full w-full object-cover" fallback={ph} />
                        ) : ph;
                      })()}
                    ...
                    <div className="p-4">
                      <div className="flex items-center gap-2">
                        {(() => {
                          ...
                          return s.creator_avatar_url ? (
                            <ImgFallback src={s.creator_avatar_url} className="h-6 w-6 rounded-full object-cover" fallback={ph} />
                          ) : ph;
                        })()}
