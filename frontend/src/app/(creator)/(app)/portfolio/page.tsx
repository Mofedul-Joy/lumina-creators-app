  ...
  return (
    <div className="mx-auto max-w-4xl px-5 py-8 sm:px-8">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <StatCard label="Earned" value={fmtMoney(c.total_earned)} icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 3v18M8 7h6a3 3 0 010 6H8m0 0h8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>} />
        ...
        <StatCard label="Engagement" value={`${c.engagement_rate}%`} icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M3 17l5-5 4 4 8-8M21 8v5h-5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>} />
