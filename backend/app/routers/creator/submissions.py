...
from app.schemas.submission import SubmissionCreateIn, SubmissionOut
...
def _out(s: Submission) -> SubmissionOut:
    return SubmissionOut(
        ...
        verification_status=s.verification_status, thumbnail_url=s.thumbnail_url, created_at=s.created_at,
    )
